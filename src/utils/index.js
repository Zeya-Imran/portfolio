...
import ReNft from "../assets/images/RE-nft.png";
import ReScaleModel from "../assets/images/RE-scale-model.png";
...
import amar_pic from "../assets/images/amar.jpeg";
...
export const BootstrapImg = Bootstrap;
export const AWSImg = AWS;
export const BitbucketImg = Bitbucket;
export const DockerImg = Docker;
export const ExpressImg = Express;
export const GitImg = Git;
export const GithubImg = Github;
export const HTTPImg = HTTP;
export const MongoDBImg = MongoDB;
export const MySQLImg = MySQL;
export const NextJSImg = NextJS;
export const PHPImg = PHP;
...
// projects section images fro TechChefz
export const REAom = ReAom;
export const REStore = ReStore;
export const REScaleModel = ReScaleModel;
export const RENft = ReNft;
...
export const Amar_pic = amar_pic;
