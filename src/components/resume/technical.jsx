    ...
    return(
        <section id="projects" className="bento  w-11/12 md:w-4/5 mx-auto flex flex-col gap-y-5">
          ...
          <div className="bento-grid text-[#848484] ">
           <div className="bento-item border flex flex-wrap gap-8">
                {
                    frontend.map((item,i)=>{
                         return(
                            <>
                            <div className='flex  flex-col items-center gap-2  w-16 h-16 mx-auto'>
           ...
           <div className="bento-item border flex flex-wrap gap-8">
           {
                    backend.map((item,i)=>{
                         return(
                            <>
                            <div className='flex  flex-col items-center gap-0  w-16 h-16 mx-auto'>
                                <img src={item.imgUrl} alt={i} />
                                <p>{item.title}</p>
                            </div>
                            </>
