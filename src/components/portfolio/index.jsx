                            ...
                            return (
                                <Link href={item.url} key={i}>
                                    ...
                                    >
                                        ...
                                        <motion.div className='mb-5 px-2 flex justify-between items-end overflow-hidden'
                                        ...
                                        >
                                            ...
                                            <FaExternalLinkAlt className='icon-hover' style={{ fontSize: "24px", marginRight: "10px" }} />
                                        </motion.div>
                                    </motion.div>
                                </Link>
                            )
